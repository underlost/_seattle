...
(function($) {
	...
	$(document).ready(function() {
        ...
        // Packery blocks
        var $blocks = $('.gallery-wrapper').imagesLoaded( function() {
		...
		$(document.body ).on('post-load', function() {
			...
			$blocks.imagesLoaded( function() {
				$blocks.packery('appended', $elements, true ).packery('reloadItems').packery('layout');
				$elements.show();
				fade_images();
...
//# sourceMappingURL=maps/seattle.js.map

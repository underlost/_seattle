...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    git_deploy: {
      github: {
        options: {
          url: 'git@github.com:underlost/seattle.git',
          branch: 'gh-pages',
  ...
  grunt.registerTask('dist', ['clean', 'build-css', 'build-js', 'build-img', 'copy:fonts', 'copy:dist', 'copy:javascriptTheme', 'copy:cssTheme', 'copy:imgTheme']);
